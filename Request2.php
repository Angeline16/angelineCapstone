        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Croptop.jpg" alt="Items">
                        <div class="grid-item-details">
                        <h3>Croptop</h3>
                            <div class="item"><a href="Request.php"><i class="fas fa-tags"></i>100.00</a></div>
                            <br><p><b>Item Description</b></p><br>
                            <p>Made from ribbed knitted top, and is stretchable.</p><br>
                            <p><b>Category:</b><span style="padding-left: 50px;">Clothing</span></p>
                            <p><b>Condition:</b><span style="padding-left: 47px;">New</span></p>
                            <p><b>Color:</b><span style="padding-left: 75px;">Brown</span></p>
                            <p><b>Size:</b><span style="padding-left: 85px;">Medium</span></p>
                            <p><b>Year:</b><span style="padding-left: 80px;">2023</span></p>
                            <p><b>Brand:</b><span style="padding-left: 70px;">Zara</span></p>
                            <div><br>
                    <div>
                        <p></p>
