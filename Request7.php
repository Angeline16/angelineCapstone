...
<body>
    ...
    <div class="side-bar">
        ...
        <div class="item"><a href="Home.php" class="selected-item" style="color: #000;"><i class="fa fa-home" ></i>Home</a></div>
            ...
            <div class="item"><a href="Tradelist.php" sub-btn><i class="fas fa-tasks"></i>Trade List
                    <!--dropdown-->
                    <!--dropdown arrow-->
        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Pants.jpg" alt="Items">
                        <div class="grid-item-details">
                        <h3>Cargo Pants</h3>
                            <div class="item"><a href="Request.php"><i class="fas fa-tags"></i>550.00</a></div>
                            <br><p><b>Item Description</b></p><br>
                            <p>Multiple cargo pockets with secure closures for convenient storage of essentials.</p><br>
                            <p><b>Category:</b><span style="padding-left: 50px;">Clothing</span></p>
                            <p><b>Condition:</b><span style="padding-left: 47px;">Used</span></p>
                            <p><b>Color:</b><span style="padding-left: 75px;">Beige</span></p>
                            <p><b>Size:</b><span style="padding-left: 85px;">25 Inches</span></p>
