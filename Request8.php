        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Crocs.jpg" alt="Items">
                        <div class="grid-item-details">
                        <h3>Crocs</h3>
                            <div class="item"><a href="Request.php"><i class="fas fa-tags"></i>900.00</a></div>
                            <br><p><b>Item Description</b></p><br>
                            <p>Classic clog design with ventilated ports for breathability and drainage.</p><br>
                            ...
                            <p><b>Size:</b><span style="padding-left: 85px;">40 EU</span></p>
                            <p><b>Year:</b><span style="padding-left: 80px;">2021</span></p>
                            <p><b>Brand:</b><span style="padding-left: 70px;">Crocs</span></p>
                            <div><br>
                    <div>
                        <p></p>
