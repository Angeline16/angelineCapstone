...
<body>
    ...
    <div class="side-bar">
        ...
        <!--Menu Bars-->
        <div class="menu">
        <div class="item"><a href="" class="selected-item" style="color: #000;"><i class="fa fa-home" ></i>Home</a></div>
        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Baby clothes.jpg" alt="Items">
                        <div class="grid-item-details">
                        <h3>Bodysuit for baby boy</h3>
                            <div class="item"><a href="Request.php"><i class="fas fa-tags"></i>300.00</a></div>
                            <br><p><b>Item Description</b></p><br>
                            <p>Adorable prints, patterns, and colors to add a touch of charm to your baby's wardrobe.</p><br>
                            <p><b>Category:</b><span style="padding-left: 50px;">Clothing</span></p>
                            <p><b>Condition:</b><span style="padding-left: 47px;">Used</span></p>
                            <p><b>Color:</b><span style="padding-left: 75px;">Blue</span></p>
                            <p><b>Size:</b><span style="padding-left: 85px;">3-5 months</span></p>
                            <p><b>Year:</b><span style="padding-left: 80px;">2022</span></p>
                    ...
                    <div>
                        ...
                        <p>Johnsons baby Soaps</p>
                        <p>Diapers</p>
                        <p>Nestogen for 1-12 months</p>
                    </div>
