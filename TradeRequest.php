...
<head>
    ...
    <link rel="stylesheet" href="styles/TradeRequest.css">
...
<!-- Add Item -->
        ...
        <span class="add-item" style="font-size: 25px; margin-left: 10px;"><b>Trade Request</span><br>
        <meta charset="UTF-8"><br>

        </head>
<body>  
    <div class="container">
    <a href="TradeRequest1.php"><p class="product-title">Nike Air Force 1 Blue Paisley</p><br>
    <div class="image">
    <img src="assets/Items/Nike.jpg" alt="Baby Bodysuit">
    </div>
    <div class="details">
        <p class="completed"><strong></strong> Trader's Request</p>
        <p><strong></strong> Cecilia Lopez</p>
        <p><strong></strong> Sarah Mendez</p>
        <p><strong></strong> Veronica Zabar</p>
        <p><strong></strong> Jerome Nace</p>
        <p><strong></strong> Leslie Corpuz</p>
        </div>
    </div>
    </div>
    </div>
