        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Necklace.jpg" alt="Items">
                        ...
                        <h3>Flower Necklace</h3>
                            ...
                            <p>The necklace features a stunning gold chain and a delicate flower pendant that is sure to catch the eye.</p><br>
