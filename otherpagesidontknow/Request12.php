        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Desk light.jpg" alt="Items">
                        <div class="grid-item-details">
                        <h3>Desk Light</h3>
                            <div class="item"><a href="Request.php"><i class="fas fa-tags"></i>1,000.00</a></div>
                            <br><p><b>Item Description</b></p><br>
                            <p>Adjustable arm and swiveling lamp head allow you to direct light exactly where you need it, providing customized illumination for reading, studying, or working.</p><br>
                            <p><b>Category:</b><span style="padding-left: 50px;">Home & Kitchen</span></p>
                            <p><b>Condition:</b><span style="padding-left: 47px;">Used</span></p>
                            <p><b>Color:</b><span style="padding-left: 75px;">Black</span></p>
                            <p><b>Size:</b><span style="padding-left: 85px;">----</span></p>
