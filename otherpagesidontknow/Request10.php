...
<body>
    ...
    <div class="side-bar">
        ...
        <div class="item"><a href="Home.php" class="selected-item" style="color: #000;"><i class="fa fa-home" ></i>Home</a></div>
            <div class="item"><a href="Dashboard.php" class="selected-item"><i class="fas fa-list"></i>Dashboard</a></div>
            <div class="item"><a href="Add.php" class="selected-item" style="color: #87ceeb;"><i class="fas fa-cart-plus"></i>Add Item</a></div>           
        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Terno.jpg" alt="Items">
                        <div class="grid-item-details">
                        <h3>Terno for baby girl</h3>
                            <div class="item"><a href="Request.php"><i class="fas fa-tags"></i>300.00</a></div>
                            <br><p><b>Item Description</b></p><br>
                            <p>Easy to care for, machine washable fabric, allowing for hassle-free maintenance and lasting quality..</p><br>
                            <p><b>Category:</b><span style="padding-left: 50px;">Clothing</span></p>
                            <p><b>Condition:</b><span style="padding-left: 47px;">New</span></p>
                            <p><b>Color:</b><span style="padding-left: 75px;">Pink</span></p>
                            <p><b>Size:</b><span style="padding-left: 85px;">12 months</span></p>
                            <p><b>Year:</b><span style="padding-left: 80px;">2024</span></p>
                    ...
                    <div>
                        ...
                        <p>Baby girl's slipper size 8</p>
                        <p>Dress for baby girl</p>
                        <p>Toys</p>
                    </div>
