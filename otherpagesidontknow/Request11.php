...
<body>
    ...
    <div class="side-bar">
        ...
        <!--Menu Bars-->
        <div class="menu">
        <div class="item"><a href="Home.php" class="selected-item" style="color: #000;"><i class="fa fa-home" ></i>Home</a></div>
        ...
        <div class="item"><a href="Tradelist.php" class="sub-btn" style="color: #000;"><i class="fas fa-tasks"></i>Trade List
                    <!--dropdown-->
                    <!--dropdown arrow-->
        ...
        <div style="float:right; width: calc(100% - 250px); height: 100vh; margin-top: 5px; border-radius: 20px; background-color: white;">
            ...
            <div class="item"><a href="Dashboard.php"><i class="fas fa-arrow-circle-left"></i></a></div><br>
                <div class="photo-grid">
                    <div class="grid-item">
                        <img src="assets/Items/Iphone.jpg" alt="Items">
                        <div class="grid-item-details">
                        <h3>Iphone XR</h3>
                            <div class="item"><a href="Request.php"><i class="fas fa-tags"></i>25,000.00</a></div>
                            <br><p><b>Item Description</b></p><br>
                            <p>Brilliant 6.1-inch Liquid Retina HD display delivers vibrant colors and crisp details for an immersive viewing experience.Brilliant 6.1-inch Liquid Retina HD display delivers vibrant colors and crisp details for an immersive viewing experience.</p><br>
                            <p><b>Category:</b><span style="padding-left: 50px;">Mobile Phones & Gadgets</span></p>
                            <p><b>Condition:</b><span style="padding-left: 47px;">Used</span></p>
                            <p><b>Color:</b><span style="padding-left: 75px;">White</span></p>
                            <p><b>Size:</b><span style="padding-left: 85px;">Height: 5.94 inches (150.9 mm), Width: 2.98 inches (75.7 mm)</span></p>
                            <p><b>Year:</b><span style="padding-left: 80px;">2023</span></p>
                            <p><b>Brand:</b><span style="padding-left: 70px;">Apple</span></p>
                            <div><br>
                    <div>
                        <p></p>
